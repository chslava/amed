...
if ( ! function_exists( 'dswp_scripts' ) ) :
  ...
  //wp_deregister_script('jquery');
	...
	wp_register_script( 'map', 'https://maps.google.com/maps/api/js?key='.get_field('google_map_api','option').'&amp;callback='.get_field('call_back','option'), array(), '', get_field('in_footer','option'));
