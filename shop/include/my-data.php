			...
			echo '
			    ...
			    <div id="order-company"'; if($_POST["person"] == 2) echo ' class="not-visible"'; echo '>
			    	<table cellpadding="5" cellspacing="2" border="0" width="100%">
			    		...
			    		<tr>
			     			<td class="basket-td-1" colspan="2">'.$e[134].'</td>
			     		</tr>
			    		<tr>
			    ...
			    <div id="order-person"'; if($_POST["person"] == 1) echo ' class="not-visible"'; echo '>
			    	<table cellpadding="5" cellspacing="2" border="0" width="100%">
			     		...
			     		<tr>
			     			<td class="basket-td-1" colspan="2">'.$e[124].'</td>
			     		</tr>
			     		<tr>
			    			<td class="basket-td-1" colspan="2"><input type="checkbox"  name="person_contract"'; if($_POST["person_contract"] == 2) echo 'checked="checked"'; echo ' /> '.$e[125].' <a href="'.$e[127].'" target="_blank" title="">('.$e[126].')</a></td>
			    		</tr>
			     		<tr>
			     			<td class="basket-th-1" colspan="2">'.$e[96].'</td>
			     		</tr>
			    ...
			    <div class="order-continue-left">
			    	...
			    	<input type="submit" value="'.$e[133].'" class="order-continue" name="register">
			    </div>
			</form>';
