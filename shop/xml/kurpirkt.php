...
function izvelnes($parent_id,$category,$_xml)
{
	...
	while($f1=mysql_fetch_array($r1))
	{
		...
		$pr1=mysql_query("Select * from items where parent_id='$f1[id]' and statuss='2' and copy = '0' order by place asc");
...
{
	$category=$f["name_lv"];
	$pr=mysql_query("Select * from items where parent_id='$f[id]' and statuss='2' and copy = '0' order by place asc");
