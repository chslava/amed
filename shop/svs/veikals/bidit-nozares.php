...
if($place_new!=$place_old)
{
	...
	$rep=mysqli_query($result_db,"Select * from $nos where place='$place_new' and branche_id='$id'");
	...
	else
	{
		...
		if($place_new>$place_old)
		{
			$rep2=mysqli_query($result_db,"Select * from $nos where place>'$place_old' and place<='$place_new' and id!='k' and branche_id='$id'");
