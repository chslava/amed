...
require_once("config.php");
	...
	while($parb == "off")
	{
		...
		if(file_exists("../../pictures/items/pic-small/$name_file.jpg"))
		{
			$parb = "off";
		}
		else
	...
	$dest = "../../pictures/items/pic-small/$name_file.jpg";
	...
	$dimg = imagecreatetruecolor($nw, $nh);
			...
			$dest = "../../pictures/items/pic-big/$name_file.jpg";
	...
	$ren1=mysqli_query($result_db,"Select place from images where parent_id='$name' order by place desc limit 0,1");
	...
	$laiks=time(); 
	$result = mysqli_query($result_db,"insert into images values (null,'$name','$place','$name_file')"); 
