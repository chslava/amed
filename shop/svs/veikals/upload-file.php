...
require_once("config.php");
	...
	$ren1=mysql_query("Select place from images where parent_id='$name' order by place desc limit 0,1");
	...
	$laiks=time(); 
	$result = mysql_query("insert into images values ('','$name','$place','$name_file')"); 
