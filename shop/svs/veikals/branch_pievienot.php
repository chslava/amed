			...
			<tr>
				...
				<td bgcolor="#ffffff" width="100%" valign="top" class="text">
					...
					<table cellpadding="0" cellspacing="0" width="100%">
						<tr>
		 				  <td height="30" valign="top" class="sad"><a href="index.php<?php echo $li1; ?>" class="sad_link"><?php echo $pr[0]; ?></a> <img src="<?php echo $wolf_path; ?>img/next.gif" align="absmiddle"><a href="branch.php<?php echo $li1; ?>" class="sad_link"><?php echo $pr[93]; ?></a> <img src="<?php echo $wolf_path; ?>img/next.gif" align="absmiddle"><a href="branch_pievienot.php<?php echo $li1; ?>" class="sad_link"><?php echo $pr[115]; ?></a></td>
	   				</tr>
						<tr>
							<td>
								<table cellpadding="3" cellspacing="2" style="border: 1px solid #d0d2dd" width="100%">
								<form name="jaunumi" enctype="multipart/form-data" action="branch_pievienot.php<?php echo $li1; ?>" method="post">
									<?php echo $error; ?>
									<tr>
