	...
	<head>
		...
		<script language="JavaScript">
			...
			{	
				...
				?>
					var url_text = "<?php echo $fer1["name"]."/"; ?>" + element.value;
					var title_text  = element.value + "<?php echo " | ".$fer1["name"]." | $e[4]"; ?>";
					var description_text  = element.value + "<?php echo ". ".$fer1["name"].". $e[5]"; ?>";
					var keywords_text  = element.value + "<?php echo ", ",$fer1["name"]; ?>";
				<?php
				}
				?>
		...
		<?php	require_once($wolf_path."augsa.php");?>
			...
			<tr>
				...
				<td bgcolor="#ffffff" width="100%" valign="top" class="text">
                  ...
                  <tr>
                     <td height="30" valign="top" class="sad"><a href="mainit.php<?php echo $li; ?>" class="sad_link"><?php echo $categories[2]; ?></a></td>
                  </tr>
               </table>
               	...
               	<tr>
                     <td class="standart" bgcolor="#f2f3f7" colspan="8"><b><?php echo $categories[1]; ?></b></td>
						...
						<form action="mainit_ok.php<?php echo $li; ?>" method="post" name="jaunumi">
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[2]; ?></b></td>
							<td valign="middle"><input type="text" name="name" class="input" style="width: 270px" onKeyUp="change('name')" value="<?php echo $fer["name"] ?>" id="name"></td>
						</tr>
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[4]; ?></b></td>
							<td valign="middle"><input type="text" class="input" name="title" value="<?php echo $fer["title"]; ?>" style="width: 270px" id="title"></td>
						</tr>
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[5]; ?></b></td>
							<td valign="middle"><input type="text" class="input" name="description" style="width:400px" value="<?php echo $fer["description"]; ?>"></td>
						</tr>
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[46]; ?></b></td>
							<td valign="middle"><input type="text" class="input" name="keywords" style="width: 270px" value="<?php echo $fer["keywords"]; ?>"></td>
						</tr>
                  <tr>
							...
							<td valign="middle"><input type="text" name="url" class="input" style="width: 270px" value="<?php echo $fer["url"]; ?>"></td>
						</tr>
                 <tr>
							...
							<select class="input" name="template">
                            	<option value="0"></option>                                
                               	<option value="1" <?php if($fer["template"] == 1) {echo " selected";} ?>><?php echo $menu_it[30]; ?></option>
                               	<option value="2" <?php if($fer["template"] == 2) {echo " selected";} ?>><?php echo $menu_it[31]; ?></option>
                               	<option value="3" <?php if($fer["template"] == 3) {echo " selected";} ?>><?php echo $menu_it[36]; ?></option>
                               	<option value="4" <?php if($fer["template"] == 4) {echo " selected";} ?>><?php echo $menu_it[43]; ?></option>
                            </select>
							</td>
						</tr>
						<tr>
                     	...
                     	<select class="input" name="album">
                     		...
                     		<?php
									...
									while($row=mysqli_fetch_array($ren))
									{
										...
										echo "<option value=\"$row[id]\"$sel>$a. $row[$name_lang]</option>";
										$b = 1;
										...
										while($row1=mysqli_fetch_array($ren1))
										{
											...
											echo "<option value=\"$row1[id]\"$sel>&nbsp;&nbsp;&nbsp;&nbsp;$a.$b. $row1[$name_lang]</option>";
											$b++;
										}
						...
						<tr>
							...
							<td valign="middle" class="standart">
								<input type="radio" name="type" value="1" <?php if($fer["type"] == 1) { echo "checked";} ?>><?php echo $teksti[149]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								<input type="radio" name="type" value="2" <?php if($fer["type"] == 2) { echo "checked";} ?>><?php echo $teksti[138]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="type" value="3" <?php if($fer["type"] == 3) { echo "checked";} ?>><?php echo $teksti[152]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="type" value="4" <?php if($fer["type"] == 4) { echo "checked";} ?>><?php echo $teksti[158]; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</td>
						</tr>
						
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[6]; ?></b></td>
							<td valign="middle"><input type="text" name="link" class="input" style="width: 270px" value="<?php if($fer["link"]=="null"){}else{ echo $fer["link"];} ?>"></td>
						</tr>
						<tr>
							<td valign="middle" align="right" class="standart" width="200"><b><?php echo $teksti[7]; ?></b></td>
							<td valign="middle">
							<select class="input" name="target">
								<option value="_top" <?php if($fer["target"] == "_top"){echo "selected";} ?>><?php echo $teksti[8]; ?></option>
								<option value="_blank" <?php if($fer["target"] == "_blank"){echo "selected";} ?>><?php echo $teksti[9]; ?></option>
							</select>
							</td>
						</tr>
                  <tr>
                     ...
                     while(($files=readdir($d))!==false)
                     {
                        ...
                        if($fer["icon"]==$files){$ch = " checked";}else{$ch="";}
                        echo "
                     ...
                     ?>
						...
						<tr>
							...
							<td valign="middle"><input type="submit" name="submit" class="button" value="<?php echo $teksti[28]; ?>"></td>
						</tr>
						</form>
					</table>
