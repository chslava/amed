	...
	<head>
		...
		<script language="JavaScript">
			...
			{	
				...
				?>
					var url_text = "<?php echo $fer1["url"]."/"; ?>" + element.value;
		...
		<?php	require_once($wolf_path."augsa.php");?>
			...
			<tr>
				...
				<td bgcolor="#ffffff" width="100%" valign="top" class="text">
                  ...
                  <tr>
                     <td height="30" valign="top" class="sad"><a href="pievienot.php<?php echo $li; ?>" class="sad_link"><?php if($fer["parent_id"] > 0) { echo $categories[3]; } else { echo $categories[0];} ?></a></td>
                  </tr>
               </table>
               	...
               	<tr>
                     <td class="standart" bgcolor="#f2f3f7" colspan="8"><b><?php echo $categories[1]; ?></b></td>
						...
						<form action="pievienot_ok.php<?php echo $li; ?>" method="post" name="jaunumi">
						<tr>
