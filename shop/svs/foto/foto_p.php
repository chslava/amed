...
$(function(){
	...
	$('#swfupload-control').swfupload({
		...
		.bind('uploadComplete', function(event, file){
			...
			if(redirect == 1)
			{
				window.location.href = 'foto_p.php<?php echo $li."&name=$name"; ?>';
			}
		})
	...
	<body leftmargin="0" topmargin="0" background="<?php echo $wolf_path; ?>img/fons.gif" marginheight="0" marginwidth="0">
		...
		<?php	require_once($wolf_path."augsa.php");?>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                  <tr>
                     <td valign="top" class="sad"><a href="index.php<?php echo $li1; ?>" class="sad_link"><?php echo $menu_it[13]; ?></a> <img src="<?php echo $wolf_path; ?>img/next.gif" align="absmiddle"> <a href="foto_p.php<?php echo $li1.".&name=$name"; ?>" class="sad_link"><?php echo $foto[2]; ?></a></td>
                  </tr>
                  <tr>
                     <td height="10" ></td>
                  </tr>
	 ...
	 <table cellpadding="3" cellspacing="1" border="0" width="100%" style="border: 1px solid #d0d2dd">
	  <tr>
	   <td bgcolor="#f2f3f7" class="standart"><b><?php echo "$foto[2] \"$row[name_lv]\""; ?></b></td>
	  </tr>
               ...
               <table cellpadding="3" cellspacing="2" width="100%" style="border: 1px solid #d0d2dd">
	  				...
	  				if($count > 0)
	  				{
	 					...
	 					while($rop=mysql_fetch_array($rep))
						{
	  						...
	  						echo "
							<div class=\"thumb\">
								<form method=\"post\" action=\"bidit.php$li&name=$name&k=$rop[id]\" name=\"a$a\" style=\"margin:0px;\">
								<p><a href=\"../../pictures/albums/big/$rop[file_name].jpg\" class=\"standart_link\" target=\"_blank\"><img src=\"../../pictures/albums/small/$rop[file_name].jpg\" align=\"absmiddle\" border=\"0\"></a>	</p>									
								<p><input type=\"text\" name=\"vieta\" style=\"width: 30px\" value=\"$rop[place]\" class=\"input2\">&nbsp;<INPUT TYPE=\"submit\" VALUE=\"$item[56]\" class=\"button2\">&nbsp; <INPUT TYPE=Button VALUE=\"$teksti[23]\" class=button2 onclick='go(\"foto_dzest.php$li&name=$name&k=$rop[id]\")'></p>
								</form> 
							</div>";
							$a++;
						}
