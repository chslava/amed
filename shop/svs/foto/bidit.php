...
if($place_new!=$place_old)
{
	...
	$rep=mysqli_query($result_db,"Select * from $nos where place='$place_new' and parent_id='$name'");
	...
	else
	{
		...
		if($place_new>$place_old)
		{
			$rep2=mysqli_query($result_db,"Select id,place from $nos where place>'$place_old' and place<='$place_new' and id!='k' and parent_id='$name'");
