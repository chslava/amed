...
if($place_new!=$place_old)
{
	...
	$rep=mysql_query("Select * from $nos where place='$place_new' and parent_id='$name'");
	...
	else
	{
		...
		if($place_new>$place_old)
		{
			$rep2=mysql_query("Select id,place from $nos where place>'$place_old' and place<='$place_new' and id!='k' and parent_id='$name'");
