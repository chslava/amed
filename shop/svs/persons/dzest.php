			...
			<tr>
				<td bgcolor="#ffffff" width="100%" valign="top" class="text">
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
		 				  <td height="30" valign="top" class="sad"><a href="index.php<?php echo $li1; ?>" class="sad_link"><?php echo $menu_it[8]; ?></a> <img src="<?php echo $wolf_path; ?>img/next.gif" align="absmiddle"> <a href="dzest.php<?php echo $li1."&k=$k"; ?>" class="sad_link"><?php echo $brokers[48]; ?></a></td>
	   				</tr>
					</table>
					<?php 
					$nos = "persons";
						...
						<tr>
							<td class="text">
								<table cellpadding="0" cellspacing="0" border="0" width="100%">
	  							<tr>
	   								<td class="standart"><b><?php echo $brokers[60].": <u>".$rop["name_lv"]."</u>"; ?></b></td>
	  							</tr>
