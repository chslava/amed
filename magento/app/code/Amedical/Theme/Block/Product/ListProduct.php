...
namespace Amedical\Theme\Block\Product;

use Magento\Catalog\Api\CategoryRepositoryInterface;
use Amedical\Theme\Block\Product\ProductList\Toolbar;
...
class ListProduct extends AbstractProduct implements IdentityInterface
{
    ...
    private function initializeProductCollection()
    {
        ...
        if ($toolbar->getCurrentOrder()=="view_counter"){
            $collection->addAttributeToSort('view_counter',$toolbar->getCurrentDirection());
            $collection->setCurPage((int)$toolbar->getCurrentPage());
            $collection->setPageSize((int)$toolbar->getLimit());
        } else {
